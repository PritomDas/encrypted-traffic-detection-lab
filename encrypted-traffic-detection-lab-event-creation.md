# Threat Event (Unauthorized Usage of Encrypted Browser)
...
## Created By:
- **Author Name**: Pritom Das
- **Author Contact**: https://www.linkedin.com/in/you-found-pritom/
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `October  30, 2025`  | `Pritom Das`   
